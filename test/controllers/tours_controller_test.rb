...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { date_debut: @tour.date_debut, date_fin: @tour.date_fin } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { date_debut: @tour.date_debut, date_fin: @tour.date_fin } }
